# -*- coding: utf-8 -*-
"""Package testar module can be installed and configured from here"""
...
KEYWORDS = ['testar', 'qa', 'testing', 'logging', 'functional', 'selenium', 'test']
GIT_URL = "https://github.com/netzulo/testar"
